...
var intervalMs = 500; // default
function poll(initialIntervalMs) {
	if (initialIntervalMs != null)
		intervalMs = initialIntervalMs; // Save it to use at end
	...
	setTimeout(poll, intervalMs); // In this call, initialIntervalMs == null
}
